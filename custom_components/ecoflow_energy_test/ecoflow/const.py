...
_POWERGLOW_KEYWORDS = ("powerglow", "power glow")
...
_SN_PREFIX_MAP = {
    ...
    # Confirmed 9 kW PowerGlow heating rod.
    "HF33": DEVICE_TYPE_POWERGLOW,
...
def get_device_type(product_name: str, sn: str = "") -> str:
    ...
    Returns a supported device type or DEVICE_TYPE_UNKNOWN.
    """
    ...
    for kw in _POWERGLOW_KEYWORDS:
        if kw in name:
            return DEVICE_TYPE_POWERGLOW
    if sn:
        prefix = sn[:4].upper()
