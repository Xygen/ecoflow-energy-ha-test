"""Constants for the EcoFlow Energy Test integration."""
...
DATA_SKIPPED_DEVICES = "ecoflow_energy_test_skipped_devices"
# Listen-only probes capturing raw data of devices that have no parser yet.
DATA_DEVICE_PROBES = "ecoflow_energy_test_device_probes"
...
DEVICE_TYPE_DISPLAY_NAMES: dict[str, str] = {
    ...
    DEVICE_TYPE_POWERGLOW: "PowerGlow",
}
...
# =====================================================================
# PowerGlow sensor definitions (read-only)
# =====================================================================

POWERGLOW_SENSORS: list[EcoFlowSensorDef] = [
    EcoFlowSensorDef("heating_power_w", "Heating Power", "W", "power", "measurement", "mdi:radiator", suggested_display_precision=0),
    EcoFlowSensorDef("heating_energy_kwh", "Heating Energy", "kWh", "energy", "total_increasing", "mdi:radiator", suggested_display_precision=2),
    EcoFlowSensorDef("target_power_w", "Target Power", "W", "power", "measurement", "mdi:target", suggested_display_precision=0),
    EcoFlowSensorDef("water_temperature_c", "Water Temperature", "°C", "temperature", "measurement", "mdi:thermometer-water", suggested_display_precision=1),
    EcoFlowSensorDef("target_temperature_c", "Target Temperature", "°C", "temperature", "measurement", "mdi:thermometer-check", suggested_display_precision=1),
    EcoFlowSensorDef("power_from_pv_w", "Power from PV", "W", "power", "measurement", "mdi:solar-power", suggested_display_precision=0),
    EcoFlowSensorDef("power_from_grid_w", "Power from Grid", "W", "power", "measurement", "mdi:transmission-tower", suggested_display_precision=0),
    EcoFlowSensorDef("power_from_battery_w", "Power from Battery", "W", "power", "measurement", "mdi:battery-arrow-up", suggested_display_precision=0),
    EcoFlowSensorDef("water_tank_volume_l", "Water Tank Volume", "L", "volume_storage", "measurement", "mdi:water-boiler", suggested_display_precision=0),
    EcoFlowSensorDef("self_check_pct", "Self-check Progress", "%", None, "measurement", "mdi:progress-check", "diagnostic", suggested_display_precision=0),
    EcoFlowSensorDef("mode_raw", "Mode (raw)", None, None, None, "mdi:cog", "diagnostic", disabled_by_default=True),
    EcoFlowSensorDef("run_flag_raw", "Run Flag (raw)", None, None, None, "mdi:flag", "diagnostic", disabled_by_default=True),
    EcoFlowSensorDef("run_state_raw", "Run State (raw)", None, None, None, "mdi:state-machine", "diagnostic", disabled_by_default=True),
    EcoFlowSensorDef("error_code_raw", "Error Code (raw)", None, None, None, "mdi:alert-circle-outline", "diagnostic", disabled_by_default=True),
]
...
POWERGLOW_POWER_TO_ENERGY: dict[str, str] = {
    "heating_power_w": "heating_energy_kwh",
}

POWERGLOW_ENERGY_FROM_API: list[tuple[str, str]] = []
