"""Initial setup flow steps for the EcoFlow Energy Test config flow."""
...
class SetupFlowMixin:
    ...
    def _create_entry(
        ...
        *,
        ...
        return self.async_create_entry(title="EcoFlow Energy Test", data=data)
            ...
            devices.append(
                {
                    ...
                    "product_type": str(
                        dev.get("productType", dev.get("product_type", "")) or ""
                    ),
    ...
    def _normalize_app_devices(
        ...
        The app API returns {sn, product_name, product_type, online,
        device_type} per device
            ...
            devices.append(
                {
                    ...
                    "name": product_name,
                    "product_name": product_name,
                    "product_type": str(dev.get("product_type", "") or ""),
                    "device_type": device_type,
